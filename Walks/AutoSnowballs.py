...
def SimulatedPause():
    ...
    if ((rnd.random() > 0.9889) and (ClickCount > rnd.randint(100, 2000))):
        sleepy(1, rnd.randint(5, 10))
        print ("Time for a sleepy!")
    ...
    while True:
        if running:
            ...
            if (rnd.random() > 0.61789):
                sleepy(10, 50, 10) #sleeps up to 1 minute totaling 2.5 minutes
                if (rnd.random() > 0.51789):
                    sleepy(10, 50, 10) #sleeps up to 1 minute totaling 3.5 minutes

            if (rnd.random() > 0.31789):
                sleepy(5, 60, 20) #sleeps up to 1 minute totaling 4.5 minutes
            if (rnd.random() > 0.61789):
                sleepy(5, 60, 20) #sleeps up to 1 minute totaling 5.5 minutes
            if (rnd.random() > 0.81789):
                sleepy(5, 60, 20) #sleeps up to 1 minute totaling 6.5 minutes
            if (rnd.random() > 0.91789):
                sleepy(5, 60, 20) #sleeps up to 1 minute totaling 7.5 minutes
            if (rnd.random() > 0.91789):
                sleepy(30, 60, 20) #sleeps up to 1 minute totaling 8.5 minutes
                if (rnd.random() > 0.91789):
                    sleepy(60, 60, 20) #sleeps up to 2 minutes totaling 11.5 minutes
