...
def cycle():
        ...
        if (rnd.random() > 0.93):
            pyautogui.moveTo(rnd.randint(1130, 1136), rnd.randint(571, 578), rnd.random() * 0.1 + 0.31)
        clx()
        time.sleep(rnd.random() * 0.5 + 2.4)
        #Location 4
        pyautogui.moveTo(rnd.randint(875, 887), rnd.randint(663, 675), rnd.random() * 0.1 + 0.41)
        if (rnd.random() > 0.93):
...
def jog():
    ...
    pyautogui.moveTo(rnd.randint(151, 159), rnd.randint(275, 280), rnd.random() * 0.1 + 0.41)
    clx()
    time.sleep(rnd.random() * 0.71 + 9.3)
    #then move to (745, 663) and click and wait 3 seconds with a 0.1 second random
    pyautogui.moveTo(rnd.randint(742, 748), rnd.randint(661, 665), rnd.random() * 0.1 + 0.41)
    clx()
    time.sleep(rnd.random() * 0.3 + 3.3)
    #Now for spot 3; at: (1485, 602)
    pyautogui.moveTo(rnd.randint(1482, 1494), rnd.randint(599, 604), rnd.random() * 0.1 + 0.41)
    clx()
    time.sleep(rnd.random() * 1.1 + 6)
    #then move to (1570, 668) and click and wait 5 seconds with a 0.1 second random
    pyautogui.moveTo(rnd.randint(1567, 1573), rnd.randint(665, 671), rnd.random() * 0.1 + 0.41)
    clx()
...
def jog2():
    Notbotting()
    #move the mouse to the upper left (154, 277), wait, click, and wait again for 9 second
    pyautogui.moveTo(rnd.randint( 20 , 160 ), rnd.randint( 433 , 622 ), rnd.random() * 0.2 + 0.23)
    pyautogui.moveTo(rnd.randint( 50 , 60 ), rnd.randint( 533 , 542 ), rnd.random() * 0.15 + 0.33)
    if (rnd.random() > 0.83):
        pyautogui.moveTo(rnd.randint(52 , 56 ), rnd.randint( 537 , 540 ), rnd.random() * 0.1 + 0.1)
    clx()
    Notbotting()
